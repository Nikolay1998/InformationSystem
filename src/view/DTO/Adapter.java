...
public class Adapter {
    ...
    public static TrackDataObject toTrackDataObject(TrackDTO trackDTO){
        return new TrackDataObject(trackDTO.getTitle(), trackDTO.getPerformer(), trackDTO.getAlbum(), trackDTO.getGenre(), trackDTO.getDuration());
    }

    public static TrackView toTrackView(TrackDTO trackDTO){
        return new TrackView(trackDTO.getTitle(), trackDTO.getPerformer(), trackDTO.getAlbum(), trackDTO.getGenre().getTitle(), trackDTO.getDuration());
    }

    public static TrackDTO toTrackDTO(TrackDataObject trackDO){
        return new TrackDTO(trackDO.getTitle(), trackDO.getPerformer(), trackDO.getAlbum(), trackDO.getGenre(), trackDO.getDuration());
    }

    public static TrackDTO toTrackDTO(TrackView trackView){
        return new TrackDTO(trackView.getTitle(), trackView.getPerformer(),
